...
import { CreateTableCommand, CreateTableCommandInput, DescribeTableCommandInput, KeyType, ScalarAttributeType, waitUntilTableExists } from '@aws-sdk/client-dynamodb';
